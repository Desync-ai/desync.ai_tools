...
to a JSON file, leveraging the desync_data library for the export.
...
from desync_data import save_to_json
...
# Save the crawled pages to a JSON file
output_filepath = "output/137ventures_crawl_results.json"
save_to_json(crawl_pages, output_filepath, mode="w")